...
class RNADuplexRibosome(RNADuplex):
    ...
    def __init__(self, solution1=None, label="", args = { 'rnaMolecule1region' : None,
        ...
        RNADuplex.__init__(self,solution1=solution1, solution2=ribRNA,label=label, args=args)
        self.solution = solution1
...
class RNADuplexMFE(RNADuplex):
    """
    Manipulate the duplex MFE
    """
    def __init__(self, duplexObject, label = ""):
        RNADuplex.__init__(self,duplexObject=duplexObject)
